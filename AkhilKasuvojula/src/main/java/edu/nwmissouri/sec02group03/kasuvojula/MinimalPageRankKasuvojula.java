...
// I wrote this method with the help and Pramod and Sai Kiran Gangidi  
  ...
  public static void main(String[] args) {
    ...
    PCollection<KV<String, String>> pc1 = kasuvojulaMapper01(p,dataFolder, "go.md" );
    PCollection<KV<String, String>> pc2 = kasuvojulaMapper01(p, dataFolder,"python.md");
    PCollection<KV<String, String>> pc3 = kasuvojulaMapper01(p,dataFolder, "java.md");
    PCollection<KV<String, String>> pc4 = kasuvojulaMapper01(p, dataFolder,"README.md");
    ...
    PCollection<String> fnl = finalMaximum.apply(MapElements.into(
        ...
        .via(kv -> kv.toString()));
    fnl.apply(TextIO.write().to("kasuvojulaOut"));

    p.run().waitUntilFinish();
   
  }

  private static PCollection<KV<String, String>> kasuvojulaMapper01(Pipeline p, String dataFolder, String dataFile) {
